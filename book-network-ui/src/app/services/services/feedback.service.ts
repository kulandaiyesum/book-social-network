...
export class FeedbackService extends BaseService {
   ...
   */
  findAllFeedbacksByBook$Response(
    params: FindAllFeedbacksByBook$Params,
    context?: HttpContext
  ...
  findAllFeedbacksByBook(
    ...
    return this.findAllFeedbacksByBook$Response(params, context).pipe(
      map(
        (
          r: StrictHttpResponse<PageResponseFeedbackResponse>
        ): PageResponseFeedbackResponse => r.body
      )
    );
  }
}
